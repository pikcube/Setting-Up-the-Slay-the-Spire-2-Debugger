...
The hard part is all finished, now all you have to do is build your project, then launch the debugger with your new configuration (F5 in Visual Studio, Alt+F5 in Rider).
